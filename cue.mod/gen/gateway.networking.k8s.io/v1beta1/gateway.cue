...
#Gateway: {
	...
	spec!: {
		...
		// AllowedListeners defines which ListenerSets can be attached to
		// this Gateway.
		...
		tls?: {
			...
			// should
			// get a TLS connection. That is determined by the presence of a
			// BackendTLSPolicy.
			//
			// Support: Core
			backend?: {
			...
			// Support: Core
			frontend?: {
				// Default specifies the default client certificate validation
				// configuration
				...
				perPort?: list.MaxItems(64) & [...{
					...
					// TLS store the configuration that will be applied to all
					// Listeners handling
	...
	status?: {
		...
		// AttachedListenerSets represents the total number of
		...
		// AttachedListenerSets attachment and
		// measuring blast radius/impact of changes to a Gateway.
		attachedListenerSets?: int32 & int
