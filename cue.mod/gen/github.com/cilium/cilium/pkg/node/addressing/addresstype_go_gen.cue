...
//cue:generate cue get go github.com/cilium/cilium/pkg/node/addressing --exclude=HubbleStatus$,ControllerStatus(es)?$,ControllerList$,StatusResponse$,DebugInfo$,Endpoint(Status)?(Slice)?(List)?$
