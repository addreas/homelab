...
//cue:generate cue get go github.com/cilium/cilium/pkg/aws/eni/types --exclude=HubbleStatus$,ControllerStatus(es)?$,ControllerList$,StatusResponse$,DebugInfo$,Endpoint(Status)?(Slice)?(List)?$
