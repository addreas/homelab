...
#CueExport: {
	...
	spec?: {
		...
		decryption?: {
			...
			// The secret name containing the private OpenPGP keys used for
			// decryption.
			// A static credential for a cloud provider defined inside the
			// Secret
			// takes priority to secret-less authentication with the
			// ServiceAccountName
			// field.
			secretRef?: {
		...
		// this
		// CueExport is deleted. Valid values are ('MirrorPrune',
		// 'Delete',
	...
	apiVersion: "cue.toolkit.fluxcd.io/v1"
	kind:       "CueExport"
	metadata!: {
		name!:      string
		namespace!: string
