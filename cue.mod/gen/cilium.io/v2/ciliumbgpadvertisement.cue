		...
		advertisements!: [...{
			...
			attributes?: {
				...
				communities?: {
					...
					// Standard holds a list of "standard" 32-bit BGP Communities Attribute (RFC
					// 1997) values defined as numeric values.
			...
			interface?: {
				...
				// Each IP address applied on the interface is advertised as a /32 prefix (for
				// IPv4) or a /128 prefix (for IPv6).
				name!: string
			}
			...
			// if not specified, no objects of the type specified by AdvertisementType are
