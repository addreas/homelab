	...
	spec!: {
		...
		bgpInstances!: list.MaxItems(16) & [...{
			...
			peers?: [...{
				...
				// This configuration is derived from CiliumBGPNodeConfigOverride resource. If
				// not specified, the local address will be used for setting up peering.
				...
				// Name is the name of the BGP peer. This name is used to identify the BGP peer
