...
#CiliumLoadBalancerIPPool: {
	...
	spec!: {
		...
		// IPs of each CIDR will be allocatable.
		// If `No`, these IPs will be reserved. This field is ignored for /{31,32} and
		// /{127,128} CIDRs since
	...
	//
	// It might be possible for users to define overlapping IP Pools, we can't
	// validate or enforce non-overlapping pools
	// during object creation. The Cilium operator will do this validation and
	// update the status to reflect the ability
