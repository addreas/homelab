...
githubReleases: {
	"cloudflare/cloudflared":     "2023.6.1"
	"dani-garcia/vaultwarden":    "1.28.1"
	"esphome/esphome":            "2023.6.2"
	"grafana/grafana":            "v10.0.1"
	"home-assistant/core":        "2023.6.3"
	"jacobalberty/unifi-docker":  "v7.4.156"
	"jcmoraisjr/haproxy-ingress": "v0.14.3"
	"kubereboot/charts":          "kured-4.6.0"
	"longhorn/longhorn":          "v1.4.2"
	"ory/hydra":                  "v2.1.2"
	"ory/kratos":                 "v0.13.0"
	"zwave-js/zwave-js-ui":       "v8.19.0"
}
otherTags: {
